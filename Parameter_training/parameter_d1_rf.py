import os, time
from Function_same_block_linshi_rfd1 import generate_data, global_parameter_h, local_parameter_h_test, parameter_lambda_krr_forplot,\
...
# appendix_d1_rf= {}
# np.save('/Users/liuxiaotong/Documents/machine learning/Adaptive learning system(nowuse_addkrr_boost_rf)/Result_data/appendix_d1_rf.npy', appendix_d1_krr)
...
for th in range(10,11):
    ...
    #plt.savefig(os.path.dirname(os.getcwd()) + '/Result_figure/rf_mse_t_1trail_N2000.pdf', dpi=600, format='pdf', bbox_inches='tight', pad_inches=0.2)
    plt.show()
...
4. save parameters
'''
appendix_d1_rf['g_t'] = g_t # g_t: [42, 12, 50, 30, 48, 64, 16, 68, 12, 96, 86, 74, 96, 6, 86, 74, 88, 76, 34, 98]
appendix_d1_rf['l_t'] = l_t
appendix_d1_rf['l_t_diff'] = l_t_diff
