...
# appendix_d1_boost= {}
# np.save('/Users/liuxiaotong/Documents/machine learning/Adaptive learning system(nowuse_addkrr_boost_rf)/Result_data/appendix_d1_boost.npy', appendix_d1_krr)
...
#     ax.set_xlabel('Number of estimators (N=500, k=5)', fontsize='13')
#     ax.set_ylabel('MSE', fontsize='13')
#     plt.savefig(os.path.dirname(os.getcwd()) + '/Result_figure/Boost_mse_t_1trail_N500.pdf', dpi=600, format='pdf', bbox_inches='tight', pad_inches=0.2)
#     plt.show()
...
4. save parameters
'''
appendix_d1_boost['g_t'] = g_t  # g_t: [42, 12, 50, 30, 48, 64, 16, 68, 12, 96, 86, 74, 96, 6, 86, 74, 88, 76, 34, 98]
appendix_d1_boost['l_t'] = l_t
appendix_d1_boost['l_t_diff'] = l_t_diff
