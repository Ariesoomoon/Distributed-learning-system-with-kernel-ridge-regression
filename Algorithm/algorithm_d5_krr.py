...
'''
0. remember to choose the Function_same_block.py or Function_diff_block_warfarin.py, 
...
g_lambdas = appendix_d5_krr['g_lambda']
l_lambdas = appendix_d5_krr['l_lambda']
l_lambdas_diff = appendix_d5_krr['l_lambda_diff']
...
3. save MSE
'''
appendix_d5_krr['GEs'] = GEs
appendix_d5_krr['LEs'] = LEs
appendix_d5_krr['AEs'] = AEs
appendix_d5_krr['AE_logs'] = AE_logs
appendix_d5_krr['AE_log_actives'] = AE_log_actives

appendix_d5_krr['LE_adapt_opts'] = LE_adapt_opts
appendix_d5_krr['AE_log_actives_diff'] = AE_log_actives_diff
