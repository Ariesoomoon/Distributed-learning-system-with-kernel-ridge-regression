...
from Function_same_block import generate_data, GE_gaussiank, LE_gaussiank_test, AE_gaussiank_test, AE_adapt_gaussiank_test, \
    AE_active_gaussiank_test, AE_active_gaussiank
...
train, test, d = (10000, 5), (1000, 5), 5  # training size; testing size; dimensional of data
...
for th in range(trails):
    ...
    AE = AE_gaussiank_test(X_train, y_train, X_test, y_test, fen_num, gap, global_h, d, s)
    AE_adapt = AE_adapt_gaussiank_test(X_train, y_train, X_test, y_test, d, fen_num, gap, s, local_h)
...
trails_d5_gau2['LE_adapts'] = LE_adapts
...
trails_d5_gau2 = loadData.tolist()
print(trails_d5_gau2.keys())
global_hs_N = trails_d5_gau2['global_h_Nchange']
local_hs_N_m5 = trails_d5_gau2['local_h_m5_Nchange']
local_hs_N_m10 = trails_d5_gau2['local_h_m10_Nchange']
local_hs_N_m20 = trails_d5_gau2['local_h_m20_Nchange']
num_agent = 20  # m=5, 10, 20
...
for trail in range(trails):
    ...
    aes = []
    for i in range(1, 11):
        train, test, d = (1000 * i, 5), (1000, 5), 5  # N=1000,2000,3000,...,10000
        print('------------------------------------------------ N:', 1000 * i)
        X_train, y_train, X_test, y_test = generate_data(train, test, d)
    ...
    print(AE_log_actives)


## save MSE
# trails_d5_gau2['GEs_Nchange'] = GEs
# trails_d5_gau2['AE_active_m5_Nchange'] = AE_log_actives
# trails_d5_gau2['AE_active_m10_Nchange'] = AE_log_actives
trails_d5_gau2['AE_active_m20_Nchange'] = AE_log_actives
